...
| D-037 | Organizational funding readiness and evidence-reuse overlay (`SUAS-FUNDING-READINESS-001`) | `DECISION_PENDING`; packet: [D037_INDEX.md](D037_INDEX.md). Distinct from D-010. Not a stack bump. No runtime, spending, eligibility, or grant-application authority. |
...
D-037 remains open. [D037_INDEX.md](D037_INDEX.md) prepares an evidence-reuse overlay for operator-asserted SAM positioning and an advisory `$300` credit envelope. It does not close D-010, select a cloud provider, claim grant eligibility, authorize credit spend, or change Veteran journeys. Funding opportunity assessments sit outside the product requirement chain.
